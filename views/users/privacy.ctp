<div class = "help">
	<div class = 'base-header'>
        <a href = '/'><img src='../../webroot/img/WTF - logo.png' title="Witness the Fitness" alt="Witness the fitness logo"></img></a>
       	<h1>Witness The Fitness Privacy Policy</h1>
    </div>
    
    <div class = 'terms-wrapper'>
        <!--<h1>Witness the Fitness Privacy Policy</h1>-->
        
        <p>This Privacy Policy governs the manner in which Witness the Fitness collects, uses, maintains and discloses information collected from users (each, a "User") of the wtfitness.net website ("Site"). This privacy policy applies to the Site and all products and services offered by Witness the Fitness.</p>
        ...
        <p>Witness the Fitness may collect and use Users personal information for the following purposes:</p>
        ...
        <p>Witness the Fitness has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
        ...
        <p>If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at:</p>
            ...
            <a href = '/'>wtfitness.net</a><br/>
            <p><a href = 'mailto:admin@wtfitness.com'>admin@wtfitness.net</a></p>
		
        
        <p>This document was last updated on September 07, 2012</p>
