        ...
        foreach($pictures as $picture){
            ...
            if (1 == ($count%2)){
				...
				/*echo '<div class = "picture-delete">';
					echo '<a href = "pictures/delete/'.$picture['Picture']['id'].'"><p id = "delete">Delete</p></a>';
					if($picture['Picture']['avatar'] == 0){
						echo '<p id = "make-avatar_'.$picture['Picture']['id'].'" class = "right">Make Avatar</p>';
					}else{
						echo '<p style="display:none" id = "make-avatar_'.$picture['Picture']['id'].'" class = "right">Make Avatar</p>';
					}
				echo '</div>';*/
