...
<div class = 'home-right-shadow'>
            ...
            <?php echo $this->Session->flash(); ?>
           		<div class = 'social-header'>
                	<ul>
                    	<li class = 'li-active' id = "social-everyone">Everyone</li>
                        <li id = "social-friends">Friends</li>
                        <li id = "social-search">Search</li>
                        <li id = "social-messages">Messages</li>
                    </ul>
                </div>
              ...
              <div class = 'social-wrapper'>  
                <div class = 'social-post'  id = 'paginator_<?php echo ($page_no);?>'>
                	<?php
						echo $form->create('Post', array('action' => 'add/everyone'));
                ...
                <div class = 'social-content' id = 'social-content_<?php echo  $post['Post']['id']?>'>
                    <div class = 'social-all'>
                        <div class = 'social-avatar'>
                            <?php
								echo '<a name = "post_'.$post['Post']['id'].'"> </a>';
                                    ...
                                    <?php foreach($post['Comment'] as $comment){
										echo '<div class = "comment-each">';
											...
											echo '<div class = "comment-info">';
												echo '<a name = "comment_'.$comment['id'].'"> </a>';
        ...
        <div class='paginator'>
                <?php echo $html->link('Show More', array('controller' => 'posts', 'action' => 'index', $page_no, '#paginator'), array('id' => 'paginator'))?>
        </div>
            <?php }?>
...
<script> everyone(); commentLike(); commentAdd(); like();</script>
